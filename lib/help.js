...
module.exports = (d, cb) => {
    ...
    var result = U.help(d)
        ...
        .options({
            ...
            "grep <pattern>": {
                alias: "g",
                describe: d("Filter tests by name or name chunk (by mocha)."),
                type: "string",
                group: "Core:",
            },
            "include <sequence>": {
                describe: d("Sequence of test name chunks separated by ' | '",
                    "in order to choose tests for run."),
                type: "string",
                group: "Core:",
            },
            "exclude <sequence>": {
                describe: d("Sequence of test name chunks separated by ' | '",
                    "in order to exclude tests from run."),
                type: "string",
                group: "Core:",
            },
            "precise": {
