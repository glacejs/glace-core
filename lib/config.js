 ...
 * @prop {array<string>} [test.scopes=[]] - Array of scope names.
 * @prop {array<string>} [test.suite=[]] - Array of suite names.
 ...
 * @prop {string} [report.logsDir=report.dir] - Folder to save test logs. Can
 *  be overridden with CLI option `--report-dir`.
...
config.report.dir = path.resolve(U.cwd, U.defVal(args.reportDir, "report"));
config.report.logsDir = config.report.dir;
